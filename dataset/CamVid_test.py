...
import imgaug as ia
from myutils import get_label_info, one_hot_it, RandomCrop, reverse_one_hot, one_hot_it_v11, one_hot_it_v11_dice
import random
...
if __name__ == '__main__':
    ...
    # print (len(data))
    from myutils import reverse_one_hot, get_label_info, colour_code_segmentation, compute_global_accuracy
    print  ("loaded ")
