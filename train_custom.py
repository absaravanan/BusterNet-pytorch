...
def train(args, model, optimizer, dataloader_train, dataloader_val):
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (data, label) in enumerate(dataloader_train):
            ...
            if i*args.batch_size % 300 == 0 and i != 0:
                if not os.path.isdir(args.save_model_path):
                    os.mkdir(args.save_model_path)
                torch.save(model.module.state_dict(),
                            os.path.join(args.save_model_path, 'latest_dice_loss'+str(epoch)+'.pth'))
...
def main(params):
    ...
    # train_path = ["/home/ryzen/ai/data/coco/aadhaar_mask/train/images"]
    # train_label_path = ["/home/ryzen/ai/data/coco/aadhaar_mask/train/annotations"]
    ...
    train_path = ["/home/ryzen/ai/data/copy_move/train/pan"]
    train_label_path = ["/home/ryzen/ai/data/copy_move/train/pan"]


    test_path = "/home/ryzen/ai/data/copy_move/val/pan"
    test_label_path = "/home/ryzen/ai/data/copy_move/val/pan"
